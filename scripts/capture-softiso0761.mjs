/**
 * Local 390×844 Fit + Raise stills for softiso-0761 glance.
 * Usage: node scripts/capture-softiso0761.mjs [baseUrl]
 */
...
const outDir = '/workspace/gnome-village-review/softiso-0761'
const SEED = 0x6e0f1e
const W = 390
const H = 844
...
async function main() {
  ...
  try {
    ...
    const fit075 = '/workspace/gnome-village-review/softiso-075/01-fit-begin.png'
    try {
      ...
      if (existsSync(fitNew) && existsSync(fit075)) {
        execFileSync('convert', [
          ...
          join(outDir, 'compare-fit-076-vs-075.png'),
        ], { stdio: 'inherit' })
      }
    } catch (e) {
