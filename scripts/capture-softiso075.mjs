/**
 * Local 390×844 Fit + Raise stills for softiso-075 glance.
 * Usage: node scripts/capture-softiso075.mjs [baseUrl]
 */
...
const outDir = '/workspace/gnome-village-review/softiso-075'
const SEED = 0x6e0f1e
const W = 390
const H = 844
...
async function main() {
  ...
  try {
    ...
    // Side-by-side vs old HTML + optional 075|074
    ...
    const fit074 = '/workspace/gnome-village-review/softiso-074/01-fit-begin.png'
    try {
      ...
      if (existsSync(fitNew) && existsSync(fit074)) {
        execFileSync('convert', [
          fitNew, fit074, '+append',
          join(outDir, 'compare-fit-075-vs-074.png'),
        ], { stdio: 'inherit' })
      }
    } catch (e) {
