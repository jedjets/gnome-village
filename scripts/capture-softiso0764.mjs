/**
 * Local 390×844 Fit + Raise stills for softiso-0764 glance.
 * Usage: node scripts/capture-softiso0764.mjs [baseUrl]
 */
...
const outDir = '/workspace/gnome-village-review/softiso-0764'
const SEED = 0x6e0f1e
const W = 390
const H = 844
...
async function main() {
  ...
  try {
    ...
    const fit0763 = '/workspace/gnome-village-review/softiso-0763/01-fit-begin.png'
    try {
      ...
      if (existsSync(fitNew) && existsSync(fit0763)) {
        execFileSync('convert', [
          fitNew, fit0763, '+append',
          join(outDir, 'compare-fit-0764-vs-0763.png'),
        ], { stdio: 'inherit' })
      }
    } catch (e) {
