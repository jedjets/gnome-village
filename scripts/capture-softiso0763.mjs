/**
 * Local 390×844 Fit + Raise stills for softiso-0763 glance.
 * Usage: node scripts/capture-softiso0763.mjs [baseUrl]
 */
...
const outDir = '/workspace/gnome-village-review/softiso-0763'
const SEED = 0x6e0f1e
const W = 390
const H = 844
...
async function main() {
  ...
  try {
    ...
    const fit0762 = '/workspace/gnome-village-review/softiso-0762/01-fit-begin.png'
    try {
      ...
      if (existsSync(fitNew) && existsSync(fit0762)) {
        execFileSync('convert', [
          fitNew, fit0762, '+append',
          join(outDir, 'compare-fit-0763-vs-0762.png'),
        ], { stdio: 'inherit' })
      }
    } catch (e) {
