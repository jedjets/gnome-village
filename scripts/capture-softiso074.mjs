/**
 * Local 390×844 Fit + Raise stills for softiso-074 glance.
 * Usage: node scripts/capture-softiso074.mjs [baseUrl]
 */
...
const outDir = '/workspace/gnome-village-review/softiso-074'
const SEED = 0x6e0f1e
const W = 390
const H = 844
